...
SECRET_KEY = 'wj+u!w182n7h*%mi5_&=jbftpdpg@o217i9$#8d3f)p6$+^_ew'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'public_user.context_processors.get_all_ministry',
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'aminul35-1823@diu.edu.bd'
EMAIL_HOST_PASSWORD = '171-35-1823'
